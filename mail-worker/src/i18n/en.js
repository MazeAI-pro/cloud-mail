const en = {
	...
	feishuTenantNotAllowed: 'This Feishu organization is not allowed to sign in',
	feishuTenantAllowlistMissing: 'Feishu tenant allowlist is not configured (FEISHU_ALLOWED_TENANT_KEYS)',
	feishuTenantKeyMissing: 'Could not determine Feishu tenant. Check app scopes or contact an administrator.',
